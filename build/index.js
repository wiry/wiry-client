...
},{}],"jfzP":[function(require,module,exports) {
"use strict";
...
var formatOptions = function formatOptions(o) {
    ...
    return [typeof path === 'undefined' || path === null ? '' : ';path=' + path, typeof domain === 'undefined' || domain === null ? '' : ';domain=' + domain, typeof expires === 'undefined' || expires === null ? '' : ';expires=' + expires.toUTCString(), typeof secure === 'undefined' || secure === null || secure === false ? '' : ';secure', sameSiteValue === null ? '' : ';SameSite=' + sameSiteValue].join('');
};
...
},{}],"K8Z3":[function(require,module,exports) {
"use strict";
...
},{}],"/MD6":[function(require,module,exports) {
"use strict";
...
},{"./format-cookie":"jfzP","./parse-cookies":"K8Z3"}],"68aC":[function(require,module,exports) {
"use strict";
...
},{"./cookie-storage":"/MD6","./format-cookie":"jfzP","./parse-cookies":"K8Z3"}],"IVsl":[function(require,module,exports) {
"use strict";
...
var initCookie = function initCookie(cookies, namespace) {
  var hasSession = document.querySelector("[data-".concat(namespace, "-session]"));

  if (!hasSession) {
    throw new Error("none of the frames have a session id");
  }

  var nextSession = hasSession.getAttribute("data-".concat(namespace, "-session"));
  var previousSession = getSession(cookies, namespace);
...
var setSession = function setSession(cookies, namespace, session) {
  cookies.setItem("".concat(namespace, "-session"), session, {
    path: "/"
  });
};

var getSession = function getSession(cookies, namespace) {
  return cookies.getItem("".concat(namespace, "-session"));
};
...
function () {
  function Client(_ref) {
    ...
    var _endpoint = _ref.endpoint,
        _ref$namespace = _ref.namespace,
        _namespace = _ref$namespace === void 0 ? "wiry" : _ref$namespace,
        _ref$cookies = _ref.cookies,
        _cookies = _ref$cookies === void 0 ? new _cookieStorage.CookieStorage() : _ref$cookies;
    ...
    function () {
      ...
      regeneratorRuntime.mark(function _callee(event) {
        var endpoint, namespace, cookies, target, session, sessionEndpoint, parent, response, json;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                endpoint = _this.endpoint, namespace = _this.namespace, cookies = _this.cookies;
                target = event.target;
                session = getSession(cookies, namespace);
                sessionEndpoint = "".concat(endpoint, "?").concat(namespace, "-session=").concat(session);

                if (!target.hasAttribute("data-".concat(namespace, "-click"))) {
                  _context.next = 13;
                  break;
                }

                parent = target.closest("[data-".concat(namespace, "-id]"));
                _context.next = 8;
                return fetch(sessionEndpoint, {
                  ...
                  body: JSON.stringify({
                    type: "click",
                    data: {
                      id: parent.getAttribute("data-".concat(namespace, "-id")),
                      method: target.getAttribute("data-".concat(namespace, "-click"))
                    }
                  })
                });
...
},{"cookie-storage":"68aC"}],"Focm":[function(require,module,exports) {
"use strict";
